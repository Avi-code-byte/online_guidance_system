...
if($_POST['setid']==$_SESSION['setid'])
{
	...
	('$_SESSION[regno]','$_GET[jobid]','$dt','$filename','$_POST[message]','Enabled','Job application')";
				$queryresult  = mysqli_query($conn,$sqlins);
				if(!$queryresult)
				{
					$qresulti = 1;
...
$stquery = mysqli_query($conn,$sql);
$rsst = mysqli_fetch_array($stquery);
...
$rescompany = mysqli_query($conn,$sql);
      	...
      	<div class="row space30"> <!-- row 1 begins -->
            ...
            <div class="col-md-6">
              ...
              <h4>Job Code: <?php echo $rs['JobId']; ?></h4>
                ...
                if($rs['CompanyLogo'] == "")
					{
					echo "<a href='companymoredetails.php?companyid=$rs[CompanyId]'><img src='images/noimage.jpg' height='200' width='350'  class='img-responsive img-rounded img_bottom' ></a>";		
					}
					else
					{
            ...
            <div class="col-md-6">
				...
				?>
				 ...
				 if(isset($_SESSION['regno']))
				 {
					...
					$sqlqueryfetch = mysqli_fetch_array($sqlquery);
